...
class TrainerEditPage extends StatefulWidget {
  const TrainerEditPage({super.key, this.isEditMode = false});

  static const routeName = '/trainer-edit';
  final bool isEditMode;

  @override
  State<TrainerEditPage> createState() => _TrainerEditPageState();
}

class _TrainerEditPageState extends State<TrainerEditPage> {
  ...
  void onSavedForm() {
    if (_formKey.currentState!.validate()) {
      ...
      _usersProvider!.addTraining(trainerUser);
      debugPrint(trainerUser.toString());
      context.pop(true);
      ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            backgroundColor: Theme.of(context).primaryColor,
            showCloseIcon: true,
            content: const Text('Nuovo maestro aggiunto'),
          ),
        );
    }
  }
  ...
  Widget build(BuildContext context) {
    return LayoutWidget(
      title: Text(
        widget.isEditMode
            ? 'Modifica profilo mestro'
            : 'Aggiungi nuovo maestro',
